package com.corn.user.service.impl;

import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.dubbo.rpc.cluster.support.FailoverCluster;
import com.baomidou.mybatisplus.mapper.EntityWrapper;
import com.corn.user.UserAPI;
import com.corn.user.dao.MoocUserTMapper;
import com.corn.user.model.MoocUserT;
...
/***
 * loadbalance = roundrobin,leastActive
 * cluster:failover 失败自动切换，当出现失败，重试其它服务器 [1]。通常用于读操作，但重试会带来更长延迟
 */

@Component
@Service(interfaceClass = UserAPI.class,loadbalance = "roundrobin",cluster = "failover",retries = 3)
